...
namespace donet.io.rong.methods
{
    ...
    public class Message
    {
		 ...
		 *
	 	 ...
	 	 **/
        public CodeSuccessReslut publishPrivate(String fromUserId, String[] toUserId, IRongMessage message, String pushContent, String pushData, int? count, int verifyBlacklist, int isPersisted, int isCounted, int isIncludeSender)
        {
            ...
            postStr += "count=" + HttpUtility.UrlEncode(count == null ? "" : count.Value.ToString(), Encoding.UTF8) + "&";
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
        public CodeSuccessReslut publishGroup(String fromUserId, String[] toGroupId, IRongMessage message, String pushContent, String pushData, int isPersisted, int isCounted, int isIncludeSender)
        {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
        public CodeSuccessReslut publishDiscussion(String fromUserId, String toDiscussionId, IRongMessage message, String pushContent, String pushData, int isPersisted, int isCounted, int isIncludeSender)
        {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
        public CodeSuccessReslut publishChatroom(String fromUserId, String[] toChatroomId, IRongMessage message)
        {
		 ...
		 *
	 	 * @return CodeSuccessReslut
	 	 **/
        public CodeSuccessReslut broadcast(String fromUserId, IRongMessage message, String pushContent, String pushData, String os)
        {
